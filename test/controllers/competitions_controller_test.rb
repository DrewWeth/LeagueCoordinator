...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { active: @competition.active, at: @competition.at, description: @competition.description, name: @competition.name }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { active: @competition.active, at: @competition.at, description: @competition.description, name: @competition.name }
    assert_redirected_to competition_path(assigns(:competition))
  end
